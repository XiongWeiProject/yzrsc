package com.commodity.scw.rongyun.server;
...
import com.commodity.scw.rongyun.server.request.AddGroupMemberRequest;
import com.commodity.scw.rongyun.server.request.AddToBlackListRequest;
import com.commodity.scw.rongyun.server.request.AgreeFriendsRequest;
import com.commodity.scw.rongyun.server.request.ChangePasswordRequest;
import com.commodity.scw.rongyun.server.request.CheckPhoneRequest;
import com.commodity.scw.rongyun.server.request.CreateGroupRequest;
import com.commodity.scw.rongyun.server.request.DeleteFriendRequest;
import com.commodity.scw.rongyun.server.request.DeleteGroupMemberRequest;
import com.commodity.scw.rongyun.server.request.DismissGroupRequest;
import com.commodity.scw.rongyun.server.request.FriendInvitationRequest;
import com.commodity.scw.rongyun.server.request.JoinGroupRequest;
import com.commodity.scw.rongyun.server.request.LoginRequest;
import com.commodity.scw.rongyun.server.request.QuitGroupRequest;
import com.commodity.scw.rongyun.server.request.RegisterRequest;
import com.commodity.scw.rongyun.server.request.RemoveFromBlacklistRequest;
import com.commodity.scw.rongyun.server.request.RestPasswordRequest;
import com.commodity.scw.rongyun.server.request.SendCodeRequest;
import com.commodity.scw.rongyun.server.request.SetFriendDisplayNameRequest;
import com.commodity.scw.rongyun.server.request.SetGroupDisplayNameRequest;
import com.commodity.scw.rongyun.server.request.SetGroupNameRequest;
import com.commodity.scw.rongyun.server.request.SetGroupPortraitRequest;
import com.commodity.scw.rongyun.server.request.SetNameRequest;
import com.commodity.scw.rongyun.server.request.SetPortraitRequest;
import com.commodity.scw.rongyun.server.request.VerifyCodeRequest;
import com.commodity.scw.rongyun.server.response.AddGroupMemberResponse;
import com.commodity.scw.rongyun.server.response.AddToBlackListResponse;
import com.commodity.scw.rongyun.server.response.AgreeFriendsResponse;
import com.commodity.scw.rongyun.server.response.ChangePasswordResponse;
import com.commodity.scw.rongyun.server.response.CheckPhoneResponse;
import com.commodity.scw.rongyun.server.response.CreateGroupResponse;
import com.commodity.scw.rongyun.server.response.DefaultConversationResponse;
import com.commodity.scw.rongyun.server.response.DeleteFriendResponse;
import com.commodity.scw.rongyun.server.response.DeleteGroupMemberResponse;
import com.commodity.scw.rongyun.server.response.DismissGroupResponse;
import com.commodity.scw.rongyun.server.response.FriendInvitationResponse;
import com.commodity.scw.rongyun.server.response.GetBlackListResponse;
import com.commodity.scw.rongyun.server.response.GetFriendInfoByIDResponse;
import com.commodity.scw.rongyun.server.response.GetGroupInfoResponse;
import com.commodity.scw.rongyun.server.response.GetGroupMemberResponse;
import com.commodity.scw.rongyun.server.response.GetGroupResponse;
import com.commodity.scw.rongyun.server.response.GetTokenResponse;
import com.commodity.scw.rongyun.server.response.GetUserInfoByIdResponse;
import com.commodity.scw.rongyun.server.response.GetUserInfoByPhoneResponse;
import com.commodity.scw.rongyun.server.response.GetUserInfosResponse;
import com.commodity.scw.rongyun.server.response.JoinGroupResponse;
import com.commodity.scw.rongyun.server.response.LoginResponse;
import com.commodity.scw.rongyun.server.response.QiNiuTokenResponse;
import com.commodity.scw.rongyun.server.response.QuitGroupResponse;
import com.commodity.scw.rongyun.server.response.RegisterResponse;
import com.commodity.scw.rongyun.server.response.RemoveFromBlackListResponse;
import com.commodity.scw.rongyun.server.response.RestPasswordResponse;
import com.commodity.scw.rongyun.server.response.SendCodeResponse;
import com.commodity.scw.rongyun.server.response.SetFriendDisplayNameResponse;
import com.commodity.scw.rongyun.server.response.SetGroupDisplayNameResponse;
import com.commodity.scw.rongyun.server.response.SetGroupNameResponse;
import com.commodity.scw.rongyun.server.response.SetGroupPortraitResponse;
import com.commodity.scw.rongyun.server.response.SetNameResponse;
import com.commodity.scw.rongyun.server.response.SetPortraitResponse;
import com.commodity.scw.rongyun.server.response.SyncTotalDataResponse;
import com.commodity.scw.rongyun.server.response.UserRelationshipResponse;
import com.commodity.scw.rongyun.server.response.VerifyCodeResponse;
import com.commodity.scw.rongyun.server.response.VersionResponse;
import com.commodity.scw.rongyun.server.utils.NLog;
import com.commodity.scw.rongyun.server.utils.json.JsonMananger;
