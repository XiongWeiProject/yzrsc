...
//                send_jiage.setText("¥"+data.optString("goodsAmount"));//价格
                ...
                if (orderGood != null && orderGood.size() != 0) {
                    rcvOderList.setLayoutManager(new LinearLayoutManager(XiaoDaiSendActivity.this));
                    orderListAdapter = new OrderListAdapter(XiaoDaiSendActivity.this, orderGood, R.layout.item_order_list);
