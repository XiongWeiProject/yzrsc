...
import com.commodity.scw.rongyun.message.module.SealExtensionModule;
import com.commodity.scw.rongyun.server.broadcast.BroadcastManager;
...
import com.commodity.scw.rongyun.server.response.ContactNotificationMessageData;
import com.commodity.scw.rongyun.server.utils.NLog;
import com.commodity.scw.rongyun.server.utils.json.JsonMananger;
import com.commodity.scw.rongyun.ui.activity.LoginActivity;
...
public class SealAppContext implements RongIM.ConversationListBehaviorListener,
    ...
    public boolean onReceived(Message message, int i) {
        ...
        if (messageContent instanceof ContactNotificationMessage) {
            ...
            NLog.e("onReceived1:" + groupNotificationMessage.getMessage());
            ...
            if (!SPManager.instance().getString(SPKeyManager.CURACTIVITYNAME).equals("ConversationActivity")){
                BusProvider.getInstance().post(new Event.ReceiverRongyunMessage(message.getSenderUserId()));
            }
        }
        return false;
    }
