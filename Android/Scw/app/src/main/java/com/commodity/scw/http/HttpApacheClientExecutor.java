...
import com.commodity.scw.http.PublishMultipartEntity.ProgressListener;
import com.commodity.scw.manager.ConfigManager;
import com.commodity.scw.model.UploadFile;
...
public class HttpApacheClientExecutor implements com.commodity.scw.http.HttpClient {
    ...
    @Override
    public void post(HttpParam param, com.commodity.scw.http.HttpResponse response) {
    ...
    public void post(HttpParam param,
                     com.commodity.scw.http.HttpResponse httpResponse, boolean isGzip) {
    ...
    public void uploadFile(HttpParam param,
                           final com.commodity.scw.http.HttpResponse httpResponse) {
        String url = param.getmUrl();
        HttpPost post = null;
        HttpEntity entity = null;
        String content = null;
     ...
     */
    @Override
    public void get(HttpParam param, com.commodity.scw.http.HttpResponse httpResponse) {
    ...
    public void delete(HttpParam param,
                       com.commodity.scw.http.HttpResponse httpResponse) {
    ...
    //处理返回的值
    private void DealResponse(HttpResponse response, HttpParam param, com.commodity.scw.http.HttpResponse httpResponse, HttpEntity entity, String content, int status, HttpMothed mothed) {
        status = response.getStatusLine().getStatusCode();
        entity = response.getEntity();
    ...
    //处理返回的值
    private void DealResponse(HttpResponse response, HttpParamNew param, com.commodity.scw.http.HttpResponse httpResponse, HttpEntity entity, String content, int status, HttpMothed mothed) {
        status = response.getStatusLine().getStatusCode();
        entity = response.getEntity();
        Header[] headArray = response.getAllHeaders();
        String UId = "";
    ...
    private void handleCallback(HttpParam param,
                                com.commodity.scw.http.HttpResponse response, String content,
