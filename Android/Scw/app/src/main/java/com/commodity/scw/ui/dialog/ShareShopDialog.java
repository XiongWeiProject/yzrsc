...
import com.commodity.scw.ui.adapter.ShareAdapter;
import com.commodity.scw.ui.adapter.ShareShopAdapter;
...
public class ShareShopDialog<T> extends Dialog implements AdapterView.OnItemClickListener {
    ...
    public ShareShopDialog(Context context, ShareEntity data) {
    ...
    private void init() {
        ...
        list.add(data);
        list.add(data);
        ShareShopAdapter shareAdapter = new ShareShopAdapter(context, list, R.layout.item_grid_proview);
