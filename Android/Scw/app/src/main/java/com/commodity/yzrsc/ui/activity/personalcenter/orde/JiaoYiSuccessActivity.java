...
//                send_jiage.setText("¥"+data.optString("goodsAmount"));//价格
                ...
                if (orderGood != null && orderGood.size() != 0) {
                    rcvOderList.setLayoutManager(new LinearLayoutManager(JiaoYiSuccessActivity.this));
                    orderListAdapter = new OrderListAdapter(JiaoYiSuccessActivity.this, orderGood, R.layout.item_order_list);
