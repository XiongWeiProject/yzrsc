package com.commodity.scw.ui.activity.shortvideo;
...
/**
 * Created by liyushen on 2017/6/4 12:11
 * 短视频录制
 */
public class ShortVideoRecorderActivity extends BaseActivity {
    ...
    protected int getContentView() {
        return R.layout.activity_shortvideo_recorder;
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (mRecorderView.getTimeCount() > 1)
                        ...
                        mRecorderView.stop();
                        Toast.makeText(ShortVideoRecorderActivity.this, "视频录制时间太短", Toast.LENGTH_SHORT).show();
                    }
                }
                return true;
            }
