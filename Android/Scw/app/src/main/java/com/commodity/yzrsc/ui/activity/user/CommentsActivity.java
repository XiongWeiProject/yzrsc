...
import com.commodity.yzrsc.ui.adapter.CommentsAdapter;
...
/**
 * Created by liyushen on 2017/4/3 22:36
 * 评论
 */
public class CommentsActivity  extends BaseActivity {
    ...
    protected void initView() {
        ...
        adapter=new CommentsAdapter(this,dataList,R.layout.item_comments);
            ...
            if (resultJson!=null&&resultJson.optBoolean("success")){
                ...
                if (dataArray != null) {
                    for (int i = 0; i < dataArray.length(); i++) {
                        try {
                            Comments data= GsonUtils.jsonToObject(dataArray.getJSONObject(i).toString(),Comments.class);
                            dataList.add(data);
