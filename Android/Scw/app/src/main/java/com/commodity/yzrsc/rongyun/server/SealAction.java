package com.commodity.yzrsc.rongyun.server;
...
import com.commodity.yzrsc.rongyun.server.request.AddGroupMemberRequest;
import com.commodity.yzrsc.rongyun.server.request.AddToBlackListRequest;
import com.commodity.yzrsc.rongyun.server.request.AgreeFriendsRequest;
import com.commodity.yzrsc.rongyun.server.request.ChangePasswordRequest;
import com.commodity.yzrsc.rongyun.server.request.CheckPhoneRequest;
import com.commodity.yzrsc.rongyun.server.request.CreateGroupRequest;
import com.commodity.yzrsc.rongyun.server.request.DeleteFriendRequest;
import com.commodity.yzrsc.rongyun.server.request.DeleteGroupMemberRequest;
import com.commodity.yzrsc.rongyun.server.request.DismissGroupRequest;
import com.commodity.yzrsc.rongyun.server.request.FriendInvitationRequest;
import com.commodity.yzrsc.rongyun.server.request.JoinGroupRequest;
import com.commodity.yzrsc.rongyun.server.request.LoginRequest;
import com.commodity.yzrsc.rongyun.server.request.QuitGroupRequest;
import com.commodity.yzrsc.rongyun.server.request.RegisterRequest;
import com.commodity.yzrsc.rongyun.server.request.RemoveFromBlacklistRequest;
import com.commodity.yzrsc.rongyun.server.request.RestPasswordRequest;
import com.commodity.yzrsc.rongyun.server.request.SendCodeRequest;
import com.commodity.yzrsc.rongyun.server.request.SetFriendDisplayNameRequest;
import com.commodity.yzrsc.rongyun.server.request.SetGroupDisplayNameRequest;
import com.commodity.yzrsc.rongyun.server.request.SetGroupNameRequest;
import com.commodity.yzrsc.rongyun.server.request.SetGroupPortraitRequest;
import com.commodity.yzrsc.rongyun.server.request.SetNameRequest;
import com.commodity.yzrsc.rongyun.server.request.SetPortraitRequest;
import com.commodity.yzrsc.rongyun.server.request.VerifyCodeRequest;
import com.commodity.yzrsc.rongyun.server.response.AddGroupMemberResponse;
import com.commodity.yzrsc.rongyun.server.response.AddToBlackListResponse;
import com.commodity.yzrsc.rongyun.server.response.AgreeFriendsResponse;
import com.commodity.yzrsc.rongyun.server.response.ChangePasswordResponse;
import com.commodity.yzrsc.rongyun.server.response.CheckPhoneResponse;
import com.commodity.yzrsc.rongyun.server.response.CreateGroupResponse;
import com.commodity.yzrsc.rongyun.server.response.DefaultConversationResponse;
import com.commodity.yzrsc.rongyun.server.response.DeleteFriendResponse;
import com.commodity.yzrsc.rongyun.server.response.DeleteGroupMemberResponse;
import com.commodity.yzrsc.rongyun.server.response.DismissGroupResponse;
import com.commodity.yzrsc.rongyun.server.response.FriendInvitationResponse;
import com.commodity.yzrsc.rongyun.server.response.GetBlackListResponse;
import com.commodity.yzrsc.rongyun.server.response.GetFriendInfoByIDResponse;
import com.commodity.yzrsc.rongyun.server.response.GetGroupInfoResponse;
import com.commodity.yzrsc.rongyun.server.response.GetGroupMemberResponse;
import com.commodity.yzrsc.rongyun.server.response.GetGroupResponse;
import com.commodity.yzrsc.rongyun.server.response.GetTokenResponse;
import com.commodity.yzrsc.rongyun.server.response.GetUserInfoByIdResponse;
import com.commodity.yzrsc.rongyun.server.response.GetUserInfoByPhoneResponse;
import com.commodity.yzrsc.rongyun.server.response.GetUserInfosResponse;
import com.commodity.yzrsc.rongyun.server.response.JoinGroupResponse;
import com.commodity.yzrsc.rongyun.server.response.LoginResponse;
import com.commodity.yzrsc.rongyun.server.response.QiNiuTokenResponse;
import com.commodity.yzrsc.rongyun.server.response.QuitGroupResponse;
import com.commodity.yzrsc.rongyun.server.response.RegisterResponse;
import com.commodity.yzrsc.rongyun.server.response.RemoveFromBlackListResponse;
import com.commodity.yzrsc.rongyun.server.response.RestPasswordResponse;
import com.commodity.yzrsc.rongyun.server.response.SendCodeResponse;
import com.commodity.yzrsc.rongyun.server.response.SetFriendDisplayNameResponse;
import com.commodity.yzrsc.rongyun.server.response.SetGroupDisplayNameResponse;
import com.commodity.yzrsc.rongyun.server.response.SetGroupNameResponse;
import com.commodity.yzrsc.rongyun.server.response.SetGroupPortraitResponse;
import com.commodity.yzrsc.rongyun.server.response.SetNameResponse;
import com.commodity.yzrsc.rongyun.server.response.SetPortraitResponse;
import com.commodity.yzrsc.rongyun.server.response.SyncTotalDataResponse;
import com.commodity.yzrsc.rongyun.server.response.UserRelationshipResponse;
import com.commodity.yzrsc.rongyun.server.response.VerifyCodeResponse;
import com.commodity.yzrsc.rongyun.server.response.VersionResponse;
import com.commodity.yzrsc.rongyun.server.utils.NLog;
import com.commodity.yzrsc.rongyun.server.utils.json.JsonMananger;
